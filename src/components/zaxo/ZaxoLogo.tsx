...
export function ZaxoLogo({ size = 64, animated = false, showText = false }: ZaxoLogoProps) {
  return (
    <div className="flex flex-col items-center gap-3">
      <div
        className={animated ? "neu-breathe rounded-3xl flex items-center justify-center" : "neu-floating rounded-3xl flex items-center justify-center"}
