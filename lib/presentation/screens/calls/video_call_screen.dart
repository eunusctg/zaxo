        ...
        children: [
          ...
          Container(
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  const ProfileAvatar(name: 'Sarah Wilson', size: AvatarSize.xl),
                  const SizedBox(height: 16),
                  const Text(
                    'Sarah Wilson',
                    style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w700, fontFamily: 'Outfit'),
                  ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: _isVideoOff
                  ? const Center(
                      child: ProfileAvatar(name: 'Me', size: AvatarSize.lg),
                    )
                  : const Center(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _ControlBtn(
                    icon: _isFrontCamera ? Icons.flip_camera_android : Icons.flip_camera_android_outlined,
                    isActive: false,
